...

{
    ...
    class Player : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        private Animation prevAni;

        private AnimationPlayer sprite = new AnimationPlayer();

        // Right
        // Stand
        private Animation RStand;
        private Animation RStand_LStand;
        private Animation RStand_RStance;
        private Animation RStand_RRStep;
        private Animation RStand_RLStep;
        // Stance
        private Animation RStance;
        private Animation RStance_LStance;
        private Animation RStance_RStand;
        private Animation RStance_RRRun;
        private Animation RStance_RLRun;
        // Walk
        private Animation RRStep_RStand;
        private Animation RLStep_RStand;
        private Animation RRStep_RLStep;
        private Animation RLStep_RRStep;
        private Animation RRStep_RLRun;
        private Animation RLStep_RRRun;
        // Run
        private Animation RRRun_RStance;
        private Animation RLRun_RStance;
        private Animation RRRun_RLRun;
        private Animation RLRun_RRRun;
        private Animation RRRun_RLStep;
        private Animation RLRun_RRStep;

        // Left
        // Stand
        private Animation LStand;
        private Animation LStand_RStand;
        private Animation LStand_LStance;
        private Animation LStand_LRStep;
        private Animation LStand_LLStep;
        // Stance
        private Animation LStance;
        private Animation LStance_RStance;
        private Animation LStance_LStand;
        private Animation LStance_LRRun;
        private Animation LStance_LLRun;
        // Walk
        private Animation LRStep_LStand;
        private Animation LLStep_LStand;
        private Animation LRStep_LLStep;
        private Animation LLStep_LRStep;
        private Animation LRStep_LLRun;
        private Animation LLStep_LRRun;
        // Run
        private Animation LRRun_LStance;
        private Animation LLRun_LStance;
        private Animation LRRun_LLRun;
        private Animation LLRun_LRRun;
        private Animation LRRun_LLStep;
        private Animation LLRun_LRStep;
        ...
        public void LoadContent(IServiceProvider serviceProvider, ContentManager content)
        {
            ...
            LoadSprite(content, "Adv_Proto");
            sprite.PlayAnimation(AniSwitch(RStand, LStand));
            //scarf.LoadContent(serviceProvider, content);
        }

        private void LoadSprite(ContentManager content, string textureSet)
        {
            // Right
            // Stand
        ...
        private Animation LoadSpriteFile(ContentManager content, string textureSet, string direction, string spriteFile)
        {
            return LoadSpriteFile(content, textureSet, direction, spriteFile, true);
        }

        private Animation LoadSpriteFile(ContentManager content, string textureSet, string direction, string spriteFile, bool repeatAnimation)
        {
            return new Animation(content.Load<Texture2D>("Player/" + textureSet + "/" + direction + "/" + spriteFile), frameRate, repeatAnimation);
        }

        public Player Update(GameTime gameTime, KeyPress keyPress, Player Player)
        {
        ...
        private void test_Movement(GameTime gameTime, Animation RightAni, Animation LeftAni, int frame, int x_positionChange, Vector2 scarfOffset)
        {
        ...
        private void Proto_Movement(GameTime gameTime, KeyPress keyPress)
        {
            switch (actionState)
            {
        ...
        /// </summary>
        private Animation AniSwitch(Animation rightSprite, Animation leftSprite)
        {
            if (facingDirection == Facing_Direction.right)
            {
                return rightSprite;
        ...
        /// </summary>
        private Animation AniSwitchStep(Animation rightSprite, Animation leftSprite)
        {
